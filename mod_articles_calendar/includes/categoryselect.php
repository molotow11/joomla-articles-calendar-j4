...
class JFormFieldCategorySelect extends JFormField {	
	...
	function fetchElement($name, $value, &$node, $control_name) {
			...
			$document->addStyleSheet(JURI::root(true).'/modules/mod_articles_calendar/assets/admin.css');
			
			$mitems[] = JHTML::_('select.option', '', '');
			
			require_once(JPATH_SITE . "/modules/mod_articles_calendar/helper.php");
			$helper = new modArticlesCalendarHelper; 
			...
			<style>
				select.ValueSelect { width: 220px; }
			</style>
			
			<script type='text/javascript'>
				
				var FilterPath = '".JURI::root(true)."/modules/mod_articles_calendar/';				
				...
				function load_base() {			
					...
					base_script.src = FilterPath+'includes/filter.admin.js';
